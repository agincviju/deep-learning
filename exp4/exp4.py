...
Original file is located at
    https://colab.research.google.com/drive/13G4A3P8hY053l7KDELexgRiZK_tqI8WQ
"""
...
xavior_model = create_model(activation='sigmoid', regularizer=regularizer, initializer=xavier_initializer)
kamming_model = create_model(activation='relu', regularizer=regularizer, initializer=kaiming_initializer)
